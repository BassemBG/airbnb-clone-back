package tn.BassemBG.airbnb_clone_back.booking.domain;

import jakarta.persistence.*;
import org.hibernate.annotations.UuidGenerator;
import tn.BassemBG.airbnb_clone_back.sharedKernel.domain.AbstractAuditingEntity;
...
public class Booking extends AbstractAuditingEntity<Long> {
    ...
    public boolean equals(Object o) {
        ...
        return totalPrice == booking.totalPrice && numberOfTravelers == booking.numberOfTravelers && Objects.equals(startDate, booking.startDate) && Objects.equals(endDate, booking.endDate) && Objects.equals(fkTenant, booking.fkTenant) && Objects.equals(fkLandlord, booking.fkLandlord);
    }

    @Override
    public int hashCode() {
        return Objects.hash(startDate, endDate, totalPrice, numberOfTravelers, fkTenant, fkLandlord);
    }
